...
class Decoder(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, last_pos, last_pos_rel, state_tuple, seq_start_end):
        """
        Inputs:
        ...
        for _ in range(self.seq_len):
            ...
            state_tuple = self.encoders(obs_traj_rel_new)
...
class TrajectoryGenerator(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, user_noise=None):
        ...
        # Encode seq
        final_encoder_h = self.encoder(obs_traj_rel)[0]
        # Pool States
...
class TrajectoryDiscriminator(nn.Module):
    ...
    def forward(self, traj, traj_rel, seq_start_end=None):
        ...
        """
        final_h = self.encoder(traj_rel)[0]
