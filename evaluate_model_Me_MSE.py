...
def getmin_helper(error,an,timeanpv, seq_start_end,timeanNE):
    ...
    return {'tr':minpoint,'pv':minpoint_pv,'ne':minpoint_NE}
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            for i in range(args.pred_len):
                ...
                out = getmin_helper(timeade,timean,timeanpv, seq_start_end,timeanNE)
        ...
        saveana(ana_outer,pv_outer,gt,neout)
...
import numpy as np
def saveana(ana_outer,ve_outer,gt,neouter):
