...
def allboxplot(tra):
    ...
    labels = '6', '12', '18', '24','36','48'  # 图例
    data = [dist[:,i] for i in range(8) if i not in [4,6]]
...
def pvplot(v):
    data = [v[:,i] for i in range(8) if i not in [4,6]]
    plt.figure(figsize=(10, 5))  # 设置画布的尺寸
    plt.title('Examples of boxplot', fontsize=20)  # 标题，并设定字号大小
    labels = '6', '12', '18', '24', '36', '48'  # 图例
    # tylist = [tylist[:, i] for i in range(6)]
