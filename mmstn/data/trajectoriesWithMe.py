...
def seq_collate(data):
    (obs_seq_list, pred_seq_list, obs_seq_rel_list, pred_seq_rel_list,
     non_linear_ped_list, loss_mask_list,obs_traj_Me, pred_traj_gt_Me, obs_traj_rel_Me, pred_traj_gt_rel_Me,tyID) = zip(*data)
    ...
    out = [
        ...
        loss_mask, seq_start_end, obs_traj_Me, pred_traj_Me, obs_traj_rel_Me, pred_traj_rel_Me, tyID
    ]
...
class TrajectoryDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        out = [
            ...
            self.obs_traj_rel_Me[start:end, :], self.pred_traj_rel_Me[start:end, :],self.tyID[start:end]
        ]
        return out